          ...
          <div className="content-area-2">
            ...
            <div className="info-text">
              <p>
                ...
                <br /> At CTD Project Review, we bring developers, designers,
                and innovators together to share their projects, gain valuable
                feedback, and grow. With a community that has celebrated over
                200 React and 150 Node.js projects, we’re proud to be a platform
                where ideas flourish and collaboration drives success.
                <br />
                <br />
        ...
        <div className="register-rectangle">
          <div className="text-area-register">
            <p className="register-title">
              Stay Updated on the Latest Projects!
            </p>
            <p>
